        ...
        return(
            <div className="container-fluid" id="projects">
                <div className="ccenterDiv">
                    ...
                    {/** WAC Website **/}
                    <div className="projectsMain">
                        <a href="https://github.com/worldaffairsconference/worldaffairs.ucc.on.ca"><img src={imgWAC} className="imgl"></img></a>
                        <h3>WAC Website</h3>
                        <h4 className="closed">Closed/Complete</h4>
                        <p>
                    ...
                    {/** BLGHackForChange **/}
                    <div className="projectsMain">
                        <a href="https://github.com/yodasnow/BLGHackForChange"><img src={imgSAID} className="imgl"></img></a>
                    ...
                    {/** TheNight **/}
                    <div className="projectsMain">
                        <a href="https://github.com/yodasnow/TheNight"><img src={imgNight} className="imgl"></img></a>
                        <h3>TheNight</h3>
                        <h4 className="closed">Closed/Complete</h4>
                        <p>
